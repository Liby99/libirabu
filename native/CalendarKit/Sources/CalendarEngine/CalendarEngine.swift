...
public final class CalendarEngine {
    ...
    var tlScrollTween: Tween?          // timeline (hour) scroll glide — keyboard hour-cursor follow
    var weekTween: Tween?
    var dayTween: Tween?   // fractional-day glide (day view "scroll to today"): drives daily.dom + anim
