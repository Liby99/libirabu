...
enum BandStyle {
    ...
    static let tintIdle: Double = 0.35
    static let tintHovered: Double = 0.45
    static let tintSelected: Double = 0.50
    ...
    static let selectedDash: [CGFloat] = [2, 2]      // thin dotted when just selected
