...
final class ClipboardTests: XCTestCase {
    ...
    func testClipPayloadReducedVsFull() {
        let e = CalendarEngine()
        ...
        let copy = e.clipPayload(of: id, full: false)!
        ...
        let cut = e.clipPayload(of: id, full: true)!
    ...
    func testCopyPasteIsSingleEvent() {
        let e = CalendarEngine()
        ...
        let clip = e.clipPayload(of: id, full: false)!
    ...
    func testCutPastePreservesOffset() {
        let e = CalendarEngine()
        let id = e.createBand(year: e.year, month: 6, track: 0, startDay: 10, endDay: 12, title: "Conf", color: "green")
        e.setRepeat(id, Repeat(kind: "weekly", until: "2026-08-01"))
        ...
        let clip = e.clipPayload(of: id, full: true)!
        e.cursor.keyboardActive = true; e.cursor.bandCursorActive = true
