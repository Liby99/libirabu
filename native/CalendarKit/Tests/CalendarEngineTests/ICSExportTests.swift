...
final class ICSExportTests: XCTestCase {
    ...
    func testNeighborOccurrence() {
        ...
        let third = e.neighborOccurrence(of: second!, dir: 1)
        XCTAssertEqual(third, "\(id)@2026-7-3")
        XCTAssertNil(e.neighborOccurrence(of: third!, dir: 1), "past the until date")
        XCTAssertEqual(e.neighborOccurrence(of: third!, dir: -1), second, "walks back too")
    }
}
