// Calendar preferences store: per-year track names + main/alt timezones (debounced save).

import { useCallback, useEffect, useRef, useState } from "react";
import { DEFAULT_MAIN_TZ, defaultTrackNames } from "@/lib/calendar/api";
import { AUTO_TZ, systemTz } from "../../util/timezones";
import { fetchSettings, putSettings } from "../api/apiClient";
