// Per-month track-name inputs in the left gutter (memoized per month).

import { useMemo } from "react";
import { Vp } from "../../geometry/types";
import { LABEL_W, MNAME_W, RIGHT_PAD, TRACK_H } from "../../geometry/constants";
import { bandYFor, type MonthAnim } from "../../geometry/frames";
